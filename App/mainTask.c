...
VOID mainTask(ULONG id)
{
    ...
    // rtt_printf(0, "data_float = %.0f\n", data_float);
    // rtt_printf(0, "data_float = %.1f\n", data_float);
    // rtt_printf(0, "data_float = %.2f\n", data_float);
    // rtt_printf(0, "data_float = %.3f\n", data_float);
    // rtt_printf(0, "data_float = %.4f\n", data_float);
    // rtt_printf(0, "data_float = %.5f\n", data_float);
    // rtt_printf(0, "data_float = %.6f\n", data_float);
    // rtt_printf(0, "data_float = %.7f\n", data_float);
    // rtt_printf(0, "-data_float = %f\n", -data_float);
    // rtt_printf(0, "-data_float = %03.5f\n", -data_float);
    // rtt_printf(0, "-data_float = %6.5lf\n", -data_float);

    // rtt_printf(0, "data_double = %.0lf\n", data_double);
    // rtt_printf(0, "data_double = %.1lf\n", data_double);
    // rtt_printf(0, "data_double = %.2lf\n", data_double);
    // rtt_printf(0, "data_double = %.3lf\n", data_double);
    // rtt_printf(0, "data_double = %.4lf\n", data_double);
    // rtt_printf(0, "data_double = %.5lf\n", data_double);
    // rtt_printf(0, "data_double = %.6lf\n", data_double);
    // rtt_printf(0, "data_double = %.7lf\n", data_double);
    // rtt_printf(0, "-data_double = %lf\n", -data_double);
    // rtt_printf(0, "-data_double = %03.5lf\n", -data_double);
    // rtt_printf(0, "-data_double = %6.5lf\n", -data_double);
